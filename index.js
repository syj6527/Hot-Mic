...
const MODE_SUBSTYLES = {
    ...
    wiki: [
        '【위키백과 st】 중립·객관 백과사전체. 항목 정의로 시작("「○○」은(는) ~을 가리킨다"). "~로 여겨진다", "~로 알려져 있다", "논란이 있다", "일각에서는 ~라는 해석도". 각주는 [3][8][14]처럼 불규칙하게 띄엄띄엄(순서대로 X). 진지한 학술 문체.',
        '【나무위키 st】 덕질 위키 특유의 드립·여담. 취소선 드립(예: ~~사실 그냥 좋아하는 거~~), "~한 것으로 유명하다", "~카더라", "~드립이 흥했다", "(아니라고는 안 했다)", "여담으로". 진지한 척하다 잡지식·드립 폭발. 괄호치고 딴소리.',
